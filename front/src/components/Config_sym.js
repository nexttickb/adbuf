...
export default  {
	...
	langSelectList:{
		...
		gridConfig:{
			columns:[
				{label:"语言种类", field:"lang_name", type:"text", width: 1.5, align:'center', searchType:'string'},
			],
	...
	langList:{
		...
		gridConfig:{
			columns:[
				{label:"id", field:"lang_id", type:"text", width: 1, align:'center'},	
				{label:"语言种类", field:"lang_name", type:"text", width: 1.5, align:'center', searchType:'string'},
				{label:"备注", field:"lang_remarks", type:"text", width: 2, align:'center', searchType:'string'}
			],
	...
	langEdit:{
		...
		formConfig : {
			form:[
				{"name": "lang_id", 	"value":"",	"label": "id","cols": 1,"order": 0,"type": "hidden"},
				{"name": "lang_name", 	"value":"",	"label": "语言名称","cols": 1,"order": 0,"type": "input"},
				{"name": "lang_remarks", 	"value":"",	"label": "备注","cols": 3,"order": 0,"type": "textarea"},
			]
		},
		button:[{name:'cancel', label:'取消'},{name:'ok', label:'确认'}]
	},
	langAdd:{
		...
		formConfig : {
			form:[
				{"name": "lang_id", 	"value":"",	"label": "语言id","cols": 1,"order": 0,"type": "input"},
				{"name": "lang_name", 	"value":"",	"label": "语言名称","cols": 1,"order": 0,"type": "input"},
				{"name": "lang_remarks", 	"value":"",	"label": "备注","cols": 3,"order": 0,"type": "textarea"},
			]
		},
	...
	corpusList:{
		...
		gridConfig:{
			columns:[
				...
				{label:"语言", field:"lang_id", type:"text", width: 1.5, align:'center', searchType:'string'},
	...
	corpusEdit:{
		...
		formConfig : {
			form:[
				...
				{"name": "lang_id", 	"value":"",	"label": "语言","cols": 2,"order": 0,"type": "input"},
